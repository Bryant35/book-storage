...
<body>
    <div class="flex text-gray-900 min-h-screen">
        ...
        <div class="mx-3 my-3 flex-1 bg-white rounded-lg shadow-lg p-4">
            <h2 class="text-2xl font-bold uppercase">Edit User {{ $user->username }}</h2>
                    ...
                    <form action="/user/update" method="post">
                        ...
                        <div class="flex justify-between">
                            ...
                            <button type="submit" name="submit"
                                ...
                                value="changePass">Save and Change Password</button> --}}
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-gray-200 rounded-lg shadow-sm">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-black">Would you like to <strong>save the data only</strong>, or also update the <strong>password</strong>?</h3>
                                            <button type="submit" name="submit"
                                                class="hover:shadow-form rounded-md bg-green-500 py-2.5 px-5 ms-3 text-sm font-semibold text-white outline-none hover:bg-green-700"
                                                value="save">
                                                Data Only
                                            </button>
                                            <button type="submit" name="submit"
                                                class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 bg-blue-500 hover:bg-blue-700 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-100"
                                                value="changePass">Save & Change Password</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
