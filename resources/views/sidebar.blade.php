  ...
  <aside class="flex sticky top-0 left-0 h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
    ...
    <nav class="flex flex-1 flex-col gap-y-2 pt-5 m-2  min-w-10">
      <a href="/system/home" class="group relative rounded-xl bg-gray-100 p-2 text-blue-600 hover:bg-gray-100">
      ...
      <a href="#" class="text-gray-400 group relative rounded-xl p-2 hover:bg-gray-100">
    ...
    <div class="flex flex-col items-center gap-y-4 py-10 m-auto">
      ...
      <a href="/validate/logout" class="group relative rounded-xl p-2 text-gray-400 hover:text-gray-900 hover:bg-gray-100">
      <i class="bi bi-door-closed-fill hover:bi-door-open-fill"></i>
      </a>
    </div>
  </aside>
